 ...
 * @author Aealen
 */
public class UsrActEditUI extends javax.swing.JFrame {
    private ActService actService;
    private UsrActService usrActService;
    private Activity activity;
    /** Creates new form UsrActEditUI */
    public UsrActEditUI() {
    ...
    private void initComponents() {
        ...
        ActManagementMenu.setEnabled(false);
        ...
        UsrManagementMenu.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsrActEditUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsrActEditUI().setVisible(true);
            }
        });
    }
