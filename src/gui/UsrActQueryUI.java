 ...
 * @author Aealen
 */
public class UsrActQueryUI extends javax.swing.JFrame {
    ActService actService;
    User user;
    UsrActService usrActService;
    /** Creates new form UsrActQueryUI */
    public UsrActQueryUI() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsrActQueryUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
